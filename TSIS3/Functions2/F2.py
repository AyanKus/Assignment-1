...
# function that takes a category name and returns just those movies under that category.
print(get_movies_by_category(movies, "Romance"))

# function that takes a list of movies and computes the average IMDB score.
print(average_imdb_score(movies))

# function that takes a category and computes the average IMDB score.
